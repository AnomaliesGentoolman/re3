...
Clone the repository with `git clone --recursive https://github.com/yungDoom/re3.git`. Then `cd re3` into the cloned repository.
...
> :information_source: There are various settings in [config.h](https://github.com/yungDoom/re3/tree/re3/src/core/config.h), you may want to take a look there.
